...
*********************************************************************************************************
*/
#define SPI1_SCN_H()				GPIO_SetBits(GPIOA, GPIO_Pin_15)
#define SPI1_SCN_L()				GPIO_ResetBits(GPIOA, GPIO_Pin_15)

#define ETH_RESET_H()				GPIO_SetBits(GPIOD, GPIO_Pin_13)
#define ETH_RESET_L()				GPIO_ResetBits(GPIOD, GPIO_Pin_13)
...
#define  BSP_INT_ID_RTC_WKUP                              81    /* HASH RNG Interrupt                                   */
...
void         BSP_IntHandlerRTCWakeup          (void);
