...
#define FF_USE_LABEL	1	//设置是否支持磁盘盘符
...
#define FF_CODE_PAGE	936		//设置语言类型
...
#define FF_USE_LFN		2	//设置是否支持长文件名
...
#define FF_VOLUMES		1	//用于设置FATFS支持的逻辑设备数目
...
#define FF_MAX_SS		4096	//扇区缓冲的最大值
